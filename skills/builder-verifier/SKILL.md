...
3. Review `REPORT.md`, `REPORT.html`, `CONTEXT_PACK.md`, `evidence/` (`api/`, `db/`, `logs/`, `kafka/`, `redis/`); `EVAL_REGRESSION.md`, `KAFKA_VERIFY.md`, `REDIS_VERIFY.md`, `DB_VERIFY_QUERIES.sql`, `LOG_VERIFY_COMMANDS.md` when present
